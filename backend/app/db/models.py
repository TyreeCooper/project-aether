...
class VenueValidationEvent(Base):
    __tablename__ = "venue_validation_events"

    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    venue: Mapped[str] = mapped_column(String(32), nullable=False)
    client_order_id: Mapped[str] = mapped_column(String(96), nullable=False, unique=True)
    symbol: Mapped[str] = mapped_column(String(32), nullable=False)
    side: Mapped[str] = mapped_column(String(8), nullable=False)
    qty: Mapped[float] = mapped_column(Float, nullable=False)
    request_fingerprint: Mapped[str] = mapped_column(String(128), nullable=False, unique=True)
    ...
    __table_args__ = (
        Index("ix_venue_validation_events_created_at", "created_at"),
        Index("ix_venue_validation_events_symbol", "symbol"),
    )
...
class ShadowDecision(Base):
    ...
    qty: Mapped[float] = mapped_column(Float, nullable=False)
    in_position: Mapped[bool] = mapped_column(Boolean, nullable=False)
    ...
    __table_args__ = (
        Index("ix_shadow_decisions_created_at", "created_at"),
        Index("ix_shadow_decisions_signal", "signal"),
    )
