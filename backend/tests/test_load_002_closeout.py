...
def test_production_workflow_verifies_strategy_test_runtime_contract():
    ...
    assert "AETHER-LOAD-003-B6" in workflow
    assert "Waiting for AETHER-LOAD-003-B6 strategy-test runtime" in workflow
    assert "Expected LOAD-003-B6 strategy-test runtime never became active." in workflow
