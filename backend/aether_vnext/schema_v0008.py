"""FROZEN revision-0008 SQLAlchemy metadata for the AETHER vNext book of record.
...
def build_metadata(*, schema: str | None = "aether_vnext") -> sa.MetaData:
    ...
    sa.Table(
        ...
        sa.Column("inventory_avg", sa.Float()),
        ...
        sa.CheckConstraint("inventory_qty >= 0", name="ck_ledger_inventory_qty_nonnegative"),
